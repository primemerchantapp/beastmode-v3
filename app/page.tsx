        ...
        <>
            ...
            <div className="text-neutral-400 dark:text-neutral-600 pt-4 text-center max-w-xl text-balance min-h-28 space-y-4">
                ...
                {messages.length === 0 && (
                    <>
                        <p>
                            Meet Alex Developer, generated from the powerful{" "}
                            <A href="https://aitekph.com">Emilio Language Model</A>,{" "}
                            delivering unmatched precision and efficiency. Built using{" "}
                            <A href="https://aitekph.com">Aitek</A>,{" "}
                            <A href="https://aitekph.com">Voice Mode</A>, and{" "}
                        ...
                        {vad.loading ? (
                            ...
                            <p>Start talking to Alex Developer.</p>
                        )}
                    </>
                )}
            </div>
